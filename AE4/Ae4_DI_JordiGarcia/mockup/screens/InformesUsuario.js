...
class InformesUsuario extends Component {
      ...
      <View style={styles.contenidor}>
        ...
        <View style={styles.contenidor}>
          ...
          <Header placement="left"
            ...
            centerComponent={{ text:'Informes Usuario PLACEMYBET', style: { color: '#fff' ,fontSize:20,textAlign:'center'} }}
        ...
        <View >
        <View>
            <Text style={{ color: 'black', fontSize:20, textAlign:'center'}}>Informes del Usuario</Text>
        </View>
        <View>
       ...
       <View style={styles.partidos}>
         <View>
         <CheckBox
  title='jordigarcia@gmail.com'
  
/>
         </View>
         <View>
         <Text style={{ color: 'black', fontSize:15, textAlign:'center'}}>1</Text>
         </View>
         <View>
...
/>
         ...
         <View>
         <Text style={{ color: 'black', fontSize:15, textAlign:'center'}}>2</Text>
         </View>
         <View>
