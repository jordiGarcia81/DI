...
class InformesAdministrador extends Component {
      ...
      <View style={styles.contenidor}>
        ...
        <View style={styles.contenidor}>
          ...
          <Header placement="left"
            ...
            centerComponent={{ text:'Informes Admin  PLACEMYBET', style: { color: '#fff' ,fontSize:20,textAlign:'center'} }}
        ...
        <View >
        <View>
            <Text style={{ color: 'black', fontSize:20, textAlign:'center'}}>Informes de Mercados Administrador</Text>
        </View>
        <View>
...
export default InformesAdministrador;